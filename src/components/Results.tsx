...
import { ArrowLeft, Star, Clock, DollarSign, TrendingUp, Zap, Shield, CheckCircle2, Lock, Award, Target, Users, BookOpen, Lightbulb, ArrowRight, X, Brain, Sparkles, Calendar, CheckCircle, AlertTriangle, Rocket, FileText, CreditCard, Eye, EyeOff, Download, Mail, Share2 } from 'lucide-react';
...
const Results: React.FC<ResultsProps> = ({ quizData, onBack, userEmail }) => {
  ...
  const generateAIContent = async (paths: BusinessPath[]) => {
    try {
      ...
      const analysis = await aiService.generateDetailedAnalysis(quizData, paths[0]);
  ...
  const handleEmailResults = async () => {
    try {
      const subject = encodeURIComponent(`Your Business Path Results - ${personalizedPaths[0]?.name}`);
      ...
      alert('Email client opened! Your results have been prepared for sending.');
    } catch (error) {
...
TOP BENEFITS:
${personalizedPaths[0]?.pros.slice(0, 5).map((pro, i) => `${i + 1}. ${pro}`).join('\n')}

POTENTIAL CHALLENGES:
${personalizedPaths[0]?.cons.slice(0, 3).map((con, i) => `${i + 1}. ${con}`).join('\n')}

REQUIRED SKILLS:
${personalizedPaths[0]?.skills.slice(0, 8).join(', ')}

YOUR OTHER TOP MATCHES:
${personalizedPaths.slice(1, 4).map((path, i) => `${i + 2}. ${path.name} (${path.fitScore}% fit)`).join('\n')}
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Personalized recommendations crafted by AI based on your unique goals, skills, and preferences
          </p>
        </motion.div>
        ...
        {isGeneratingAI ? (
          ...
          >
            ...
            <div className="relative text-center">
              ...
              <h2 className="text-3xl font-bold mb-4">AI is Analyzing Your Profile...</h2>
              <p className="text-xl text-blue-100 mb-6">
                Creating personalized insights, challenges, and success strategies just for you
              </p>
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold">Your AI-Generated Insights</h2>
                  <p className="text-blue-100">Personalized analysis based on your unique profile</p>
                </div>
              </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                  <div className="text-blue-50 leading-relaxed text-lg">
                    {hasUnlockedAnalysis ? (
                      ...
                      <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mt-6">
                          ...
                          <div>
                            ...
                            <ul className="space-y-2">
                              {aiAnalysis.successPredictors.map((predictor, index) => (
                                <li key={index} className="flex items-start">
                      ...
                      <div className="relative">
                        {(() => {
                          const { firstParagraph, secondParagraph } = splitAnalysis(aiAnalysis.fullAnalysis);
                          return (
                            <>
                          ...
                          <div className="grid md:grid-cols-2 gap-6 mt-6">
                            <div>
                              ...
                              <div className="space-y-2">
                                {aiAnalysis.keyInsights.slice(0, 2).map((_, index) => (
                                  <div key={index} className="h-4 bg-white/20 rounded"></div>
                                ))}
                              </div>
                            </div>
                            <div>
                              <h4 className="font-bold mb-3">Success Predictors</h4>
                              <div className="space-y-2">
                                {aiAnalysis.successPredictors.slice(0, 2).map((_, index) => (
                                  <div key={index} className="h-4 bg-white/20 rounded"></div>
                                ))}
                              </div>
                            </div>
                  ...
                  >
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                      ...
                      <p className="text-blue-100 mb-6">
                        Get the full personalized analysis, detailed insights, and success strategies for just $9.99
                      </p>
                      <button
        ...
        >
          {personalizedPaths.slice(0, 3).map((path, index) => {
            const IconComponent = iconMap[path.icon as keyof typeof iconMap] || TrendingUp;
                ...
                <div className="h-full p-8 flex">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                      <div className="bg-gray-50 rounded-lg p-3">
                        <div className="flex items-center mb-1">
                          ...
                          <span className="text-xs font-medium text-gray-700">Time to Profit</span>
                        </div>
                        <div className="font-bold text-gray-900 text-sm">{path.timeToProfit}</div>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-3">
                        <div className="flex items-center mb-1">
                          <DollarSign className="h-4 w-4 text-gray-500 mr-1" />
                          <span className="text-xs font-medium text-gray-700">Startup Cost</span>
                        </div>
                        <div className="font-bold text-gray-900 text-sm">{path.startupCost}</div>
                      </div>
                    </div>
                  ...
                  <div className="w-48 flex flex-col">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <div className="text-sm text-gray-500 font-medium">AI Match</div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 mb-6">
                      ...
                      <div className="text-xl font-bold text-green-700">{path.potentialIncome}</div>
                    </div>
        ...
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-6">Take Action on Your Results</h3>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Get your complete report as a downloadable file for offline reference</p>
            </button>
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Send this report to your email for easy access and sharing</p>
            </button>
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Share your business match with friends, family, and mentors</p>
            </button>
          </div>
        </motion.div>
        ...
        <motion.div 
          className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden mt-12"
          initial={{ opacity: 0, y: 60 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <motion.p 
              ...
              animate="animate"
            >
              Get detailed step-by-step action plans, curated resources, and advanced AI insights to accelerate your success
            </motion.p>
              ...
              {[
                {
                  ...
                  description: "Deep personality profiling and custom success predictions based on your unique profile"
                },
                {
                  icon: Target,
                  title: "Detailed Action Plans",
                  description: "Week-by-week roadmaps with specific milestones and success metrics"
                },
                {
                  icon: BookOpen,
                  title: "Curated Resources",
                  description: "Hand-picked tools, courses, and platforms with ratings and reviews"
                }
              ].map((feature, index) => (
                <motion.div 
                  key={index} 
            ...
            >
              <div className="text-gray-400 line-through text-xl mb-2">$197 Value</div>
              <div className="text-6xl font-bold text-white mb-2">$9.99</div>
              <div className="text-gray-300 text-lg">One-time payment • Instant access • 30-day guarantee</div>
            </motion.div>
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-center mb-8">
                  Get instant access to your personalized AI analysis, detailed insights, and step-by-step action plan.
                </p>
