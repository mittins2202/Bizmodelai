  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 bg-white shadow-lg rounded-lg p-3 hover:bg-gray-50 transition-colors"
      >
      ...
      {/* Sidebar Navigation */}
      <div className={`
        fixed lg:static inset-y-0 left-0 z-50 w-80 bg-white shadow-lg transform transition-transform duration-300 ease-in-out flex flex-col
        ...
        <div className="p-4 border-t border-gray-200 flex-shrink-0">
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-700 mb-3">
              Get personalized guidance for your business journey.
            </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative h-6 bg-gray-200 rounded-full overflow-hidden">
                    ...
                    <div 
                      ...
                      style={{
                        left: businessPath.difficulty === "Easy" ? "90%" : 
                              businessPath.difficulty === "Medium" ? "70%" : "50%"
                      }}
                    />
                  </div>
                  ...
                  <div className="text-center">
                    <span className="text-lg font-bold text-gray-900">
                      {businessPath.difficulty === "Easy" ? "90%" : 
                       businessPath.difficulty === "Medium" ? "70%" : "50%"} Scalability
                    </span>
                  </div>
                </div>
              </div>
