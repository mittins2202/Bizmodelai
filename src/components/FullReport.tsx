  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={`${showSidebar ? 'ml-64' : 'ml-0'} flex-1 transition-all duration-300`}>
        ...
        <section id="welcome" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-purple-700 to-indigo-800 text-white" style={{ paddingTop: '10vh', paddingBottom: '15vh' }}>
          <div className="text-center max-w-4xl mx-auto px-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-blue-100 mb-12 leading-relaxed">
                Your personalized business blueprint is ready. Scroll down to discover your AI-powered analysis, personality insights, and complete roadmap to success.
              </p>
              
              <button
                onClick={scrollToAIReport}
                className="bg-white text-blue-700 px-8 py-4 rounded-full font-bold text-lg hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 shadow-xl flex items-center mx-auto mb-16"
              >
        ...
        <section id="ai-report" className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-8">
            ...
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-gray-900">Together, these traits make you best suited for this business model.</h3>
            </div>
        ...
        <section id="business-overview" className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-8">
        ...
        <section id="alternatives" className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-8">
