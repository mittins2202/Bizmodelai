    ...
    >
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="flex justify-between items-start mb-4">
          <h3 className="text-xl font-bold text-gray-900 flex-1 mr-2 line-clamp-2">{model.title}</h3>
          <span className={`px-2 py-1 rounded-full text-xs font-medium flex-shrink-0 ${getDifficultyColor(model.difficulty)}`}>
            {model.difficulty}
          </span>
        </div>
        ...
        <div className="space-y-2 mb-4 flex-shrink-0">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium text-blue-600 text-right text-xs">{model.fit}</span>
          </div>
        </div>
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-gray-900 mb-2">About This Model</h4>
                <p className="text-sm text-gray-600 leading-relaxed">{model.detailedDescription}</p>
              </div>
              ...
              {/* Tools */}
              <div className="mb-4">
                <h4 className="font-semibold text-gray-900 mb-2">Common Tools</h4>
                <div className="flex flex-wrap gap-1">
